...
Network = () ->
  ...
  showDetails = (d,i) ->
    ...
    content += '<hr class="tooltip-hr">'
    content += '<img src="http://cm.wiwi.hu-berlin.de/small/' + d.id + '_01.jpg" style="width: 200px; display: block; margin-left: auto; margin-right: auto;">'
...
$ ->
  ...
  d3.json "data/producer.json", (json) ->
    myNetwork("#vis", json)
